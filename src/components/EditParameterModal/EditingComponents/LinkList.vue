<template>
    <div>
        <input type="hidden" :name="name" :value="list_value" class="edition_input"/>
        <div class="row">
        ...
        <div>
            <ul v-for="(text, index) in text_list" :key="index">
                <li>
                    ...
                    &nbsp;&nbsp;<button class="btn btn-outline-red" @click="remove_value(index)"><VueFeather type="trash" /></button>
                </li>
            </ul>
        </div>
    </div>
